...
let serviceAccount = require("./shop-ecommerce-b616a-firebase-adminsdk-po9j1-a7a51708df.json");
...
app.post("/signup", (req, res) => {
    let { fname, email, password, number, tac, notification } = req.body;

    // form validations

    if (fname.length < 3) {
        return res.json({"alert" : "name must be more than 3 letters long"})
